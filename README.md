...
The stories from this project are listed on [FreeCodeCamp](https://www.freecodecamp.org/challenges/build-a-simon-game).
...
Clone the repo, `https://gitlab.com/jacebenson/fcc-simon.git`
```
git clone https://gitlab.com/jacebenson/fcc-simon.git
```
